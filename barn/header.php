...
function generateHeader() {
    ...
    <table width="925" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="195" valign="top" bgcolor="#D3E4D3">
        ...
        <td width="10" valign="top" bgcolor="#F9F3E3"><img src="/images/graphics/yellow 10pt bar top copy.jpg" width="10" height="10" /></td>
        <td width="720" bgcolor="#D3E4D3" valign="top">
